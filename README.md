...
#### Usage
Write matchless payloads just like described in the official docs. Simply omit any MATCH commands or comment them out for the payload to run on boot. **Also note the following considering the execution of payloads using these framework mods:**
